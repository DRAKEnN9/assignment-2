...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl p-4
          transform transition-transform duration-200
          ${isOpen ? "translate-x-0" : "-translate-x-full"}
          md:static md:translate-x-0 md:w-64 md:p-4 flex flex-col
        `}
      >
        ...
        <nav className="flex flex-col gap-1.5 pb-3 ml-5 mt-20">
        ...
        {/* Contact Support remains a link */}
